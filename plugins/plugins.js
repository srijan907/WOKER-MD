...
const REPO_OWNER = 'sreejan-xd';
const REPO_NAME = 'WOKER-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *WOKER MD V1 PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*WOKER MD V1 PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://cdn.ironman.my.id/i/vzry3x.jpg` }, // Replace with your image URL
